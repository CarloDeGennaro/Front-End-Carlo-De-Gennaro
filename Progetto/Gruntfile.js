...
grunt.initConfig({
 ...
 babel: {
  ...
  dist: {
   files: {
    'src/js/boundle-es5.js': 'src/js/boundle.js'
   }
  }
 },
 cssmin: {
  target: {
   files: {
    'dist/css/style2.min.css': ['node_modules/bootstrap/dist/css/bootstrap.css','src/css/style2.css']//vettore di 2 elementi
 ...
 uglify: {
  target: {
   files: {
    'dist/js/boundle.min.js': 'src/js/boundle-es5.js'
   }
  }
 }
